...
APP_FULL_NAME="Dockge"                              # Full name of the App that will be installed (only used for console output)
APP_NAME="dockge"                                   # The folder name of the App (do not use spaces! only use lowercase and - or _ )
APP_SERVICE="Dockge"                                # The Name of the Service (Container Name) for the Compose File
...
APP_PORT="5001"                                     # This is the Port Number which will be exposed for public access
TCP_PORT="5001"                                     # This is the Port Number the Docker Container uses internally
SYS_IP="172.22.0.9"                                 # The (fixed) IP for the Docker Container (Gateway must already exist!)
#------------------------------------------------------------------------------------------------------------------------------------------------------
# VOLUME & LOCAL MOUNT POINTS
DATA_VOLUME="DockgeStorage"                         # Name of the Docker Volume -> Only needed if app needs a Docker Volume!
