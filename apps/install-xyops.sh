...
This Shell Script will install & configure the following App: xyOps
Place this script in /usr/local/bin make it executable and run it with sudo privileges
URL: https://docs.xyops.io/#Docs/hosting  OR  https://docs.xyops.io/#Docs/welcome
⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆
TEST RESULTS:  SUCCESSFULLY TESTED ON WSL2/DEBIAN ON 09.06.2026
⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆
Script Name:   install-xyops.sh
...
APP_FULL_NAME="xyOps"                               # Full name of the App that will be installed (only used for console output)
APP_NAME="xyOps"                                    # The folder name of the App (do not use spaces! only use lowercase and - or _ )
APP_SERVICE="xyOps"                                 # The Name of the Service (Container Name) for the Compose File
...
APP_PORT="5522"                                     # This is the Port Number which will be exposed for public access
TCP_PORT="5523"                                     # This is the Port Number the Docker Container uses internally
APP_IP="172.24.0.26"                                # The (fixed) IP for the Docker Container (Gateway must already exist!)
APP_DOMAIN="localhost"                              # This is the Domain/URL Traefik is going to use to expose this app
#------------------------------------------------------------------------------------------------------------------------------------------------------
# VOLUME & LOCAL MOUNT POINTS
DATAVOLUME_APPDATA="${APP_NAME}AppData"             # Mounted Docker Volume
MOUNTPOINT_LOGS="${APP_PATH}/logs"                  # Local Mountpoint
MOUNTPOINT_CONF="${APP_PATH}/conf"                  # Local Mountpoint
...
CreateLocalMountPoint $MOUNTPOINT_LOGS 775 1000
CreateLocalMountPoint $MOUNTPOINT_CONF 775 1000

# Create Docker Volume using function from wsl2-lib.sh
CreateNewDockerVolume $DATAVOLUME_APPDATA $APP_NAME
...
services:
  ${APP_NAME}:
    ...
    hostname: http://${APP_DOMAIN}:${APP_PORT}
    ...
    environment:
      ...
      TZ: Europe/Berlin
      #XYOPS_masters: "${APP_DOMAIN}"
      XYOPS_base_app_url: http://${APP_DOMAIN}:${APP_PORT}
      XYOPS_email_from: "admin@xyops.local"
      XYOPS_secret_key: $(openssl rand -hex 32)

    volumes:
      - /var/run/docker.sock:/var/run/docker.sock
      - ${DATAVOLUME_APPDATA}:/opt/xyops/data
      - ${MOUNTPOINT_CONF}:/opt/xyops/conf
      - ${MOUNTPOINT_LOGS}:/opt/xyops/logs
