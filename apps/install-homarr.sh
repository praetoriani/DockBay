...
This Shell Script will install & configure the following App: Homarr
Place this script in /usr/local/bin make it executable and run it with sudo privileges
URL: https://homarr.dev/docs/getting-started/installation/docker
⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆
TEST RESULTS:  SUCCESSFULLY TESTED ON WSL2/DEBIAN ON 06.06.2026
⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆
Script Name:   install-homarr.sh
...
APP_FULL_NAME="Homarr"                              # Full name of the App that will be installed (only used for console output)
APP_NAME="homarr"                                   # The folder name of the App (do not use spaces! only use lowercase and - or _ )
APP_SERVICE="Homarr"                                # The Name of the Service (Container Name) for the Compose File
...
APP_PORT="7575"                                     # This is the Port Number which will be exposed for public access
TCP_PORT="7575"                                     # This is the Port Number the Docker Container uses internally
APP_IP="172.24.0.4"                                 # The (fixed) IP for the Docker Container (Gateway must already exist!)
APP_DOMAIN="homarr.localhost"                       # This is the Domain/URL Traefik is going to use to expose this app
#------------------------------------------------------------------------------------------------------------------------------------------------------
# VOLUME & LOCAL MOUNT POINTS
DATA_VOLUME="HomarrData"                           # Name of the Docker Volume -> Only needed if app needs a Docker Volume!
MOUNTPOINT1="${APP_PATH}/appdata"                   # Local Mountpoint for: App-Data
...
services:
  ${APP_SERVICE}:
    ...
    volumes:
      ...
      # Mount appdata to local folder
      - ./appdata:/appdata
      # Mount appdata to Docker Volume
      - ${DATA_VOLUME}:/appdata
    environment:
      - SECRET_ENCRYPTION_KEY=9e05369a9956ac64f9708e57250695903391ea494bd452ac1867c87c010570d7
