...
This Shell Script will install & configure the following App: Docking-Station
...
⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆
Script Name:   install-dockingstation.sh
...
APP_FULL_NAME="Docking-Station"                     # Full name of the App that will be installed (only used for console output)
APP_NAME="dockingstation"                           # The folder name of the App (do not use spaces! only use lowercase and - or _ )
APP_SERVICE="DockingStation"                        # The Name of the Service (Container Name) for the Compose File
...
APP_PORT="3006"                                     # This is the Port Number which will be exposed for public access
TCP_PORT="3000"                                     # This is the Port Number the Docker Container uses internally
SYS_IP="172.22.0.11"                                # The (fixed) IP for the Docker Container (Gateway must already exist!)
#------------------------------------------------------------------------------------------------------------------------------------------------------
# VOLUME & LOCAL MOUNT POINTS
DATA_VOLUME="DockingStation"                        # Name of the Docker Volume -> Only needed if app needs a Docker Volume!
MOUNTPOINTCONF="${APP_PATH}/config"                 # Local Mountpoint for: Configuration
MOUNTPOINTDATA="${APP_PATH}/data"                   # Local Mountpoint for: App-Data
MOUNTPOINTLOGS="${APP_PATH}/logs"                   # Local Mountpoint for: Log Files
MOUNTPOINTYAML="${APP_PATH}/compose"                # Local Mountpoint for: Compose Files (*.yml)
...
CreateLocalMountPoint $MOUNTPOINTCONF 775 1000

# Creating new mountpoint using function from wsl2-lib.sh
CreateLocalMountPoint $MOUNTPOINTDATA 775 1000

# Creating new mountpoint using function from wsl2-lib.sh
CreateLocalMountPoint $MOUNTPOINTLOGS 775 1000

# Creating new mountpoint using function from wsl2-lib.sh
CreateLocalMountPoint $MOUNTPOINTYAML 775 1000
...
services:
  ${APP_SERVICE}:
    ...
    volumes:
      ...
      - ${MOUNTPOINTYAML}:/mnt/compose-files
