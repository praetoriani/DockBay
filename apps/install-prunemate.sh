...
This Shell Script will install & configure the following App: PruneMate
More Informations about this App can be found here: https://prunemate.org/
...
⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆
Script Name:   install-prunemate.sh
...
APP_FULL_NAME="PruneMate"                           # Full name of the App that will be installed (only used for console output)
APP_NAME="prunemate"                                # The folder name of the App (do not use spaces! only use lowercase and - or _ )
APP_SERVICE="PruneMate"                             # The Name of the Service (Container Name) for the Compose File
...
APP_PORT="3002"                                     # This is the Port Number which will be exposed for public access
TCP_PORT="8080"                                     # This is the Port Number the Docker Container uses internally
SYS_IP="172.22.0.8"                                 # The (fixed) IP for the Docker Container (Gateway must already exist!)
#----------------------------------7--------------------------------------------------------------------------------------------------------------------
# VOLUME & LOCAL MOUNT POINTS
DATA_VOLUME="PruneMateData"                         # Name of the Docker Volume -> Only needed if app needs a Docker Volume!
MOUNTPOINT1="${APP_PATH}/logs"                      # Local Mountpoint
MOUNTPOINT2="${APP_PATH}/config"                    # Local Mountpoint
...
# false for 12-Hour format (AM/PM)
PRUNEMATE_TIME_24H=true
# Enable Authentication (optional)
# generate hash with: docker run --rm anoniemerd/prunemate python prunemate.py --gen-hash "password"
