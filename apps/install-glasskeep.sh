...
This Shell Script will install & configure the following App: Glass Keep
Place this script in /usr/local/bin make it executable and run it with sudo privileges
URL: https://github.com/nikunjsingh93/react-glass-keep#-docker-deploy-to-serversingle-image-api--built-frontend
⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆
TEST RESULTS:  SUCCESSFULLY TESTED ON WSL2/DEBIAN ON 06.06.2026
⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆
Script Name:   install-glasskeep.sh
...
APP_FULL_NAME="Glass Keep"                          # Full name of the App that will be installed (only used for console output)
APP_NAME="glasskeep"                                # The folder name of the App (do not use spaces! only use lowercase and - or _ )
APP_SERVICE="GlassKeep"                             # The Name of the Service (Container Name) for the Compose File
...
APP_PORT="8080"                                     # This is the Port Number which will be exposed for public access
TCP_PORT="8080"                                     # This is the Port Number the Docker Container uses internally
API_PORT="8080"                                     # GLASSNOTE ONLY!!
APP_IP="172.24.0.13"                                # The (fixed) IP for the Docker Container (Gateway must already exist!)
APP_DB_NAME="notes.db"                              # This is the Name of the Database which is used by the Container
APP_DOMAIN="glasskeep.localhost"                    # This is the Domain/URL Traefik is going to use to expose this app
#------------------------------------------------------------------------------------------------------------------------------------------------------
# VOLUME & LOCAL MOUNT POINTS
DATA_VOLUME1="GlassKeepData"                        # Name of the Docker Volume -> Only needed if app needs a Docker Volume!
...
services:
  ${APP_SERVICE}:
    ...
    environment:
      ...
      DB_FILE: /app/data/${APP_DB_NAME}
      ADMIN_EMAILS: admin@glassnote.local   # <— change this to your admin user
      ALLOW_REGISTRATION: "true"            # <— set to "false/true" to deny/allow new account creation
    ...
    volumes:
      - ${MOUNTPOINT1}:/app/data   # <— change this to your actual home path username
...
output_note "Pass:  admin"
output_note "Mail:  admin@glassnote.local"
output_null
