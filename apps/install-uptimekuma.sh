...
This Shell Script will install & configure the following App: Uptime Kuma
...
⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆
Script Name:   install-uptimekuma.sh
...
APP_FULL_NAME="Uptime Kuma"                         # Full name of the App that will be installed (only used for console output)
APP_NAME="uptimekuma"                               # The folder name of the App (do not use spaces! only use lowercase and - or _ )
APP_SERVICE="UptimeKuma"                            # The Name of the Service (Container Name) for the Compose File
...
APP_PORT="3001"                                     # This is the Port Number which will be exposed for public access
TCP_PORT="3001"                                     # This is the Port Number the Docker Container uses internally
APP_IP="172.24.0.3"                                 # The (fixed) IP for the Docker Container (Gateway must already exist!)
SYS_IP="172.22.0.5"                                 # The (fixed) IP for the Docker Container (Gateway must already exist!)
SQL_IP="172.30.0.4"                                 # The (fixed) IP for the Docker Container (Gateway must already exist!)
APP_DOMAIN="uptime.localhost"                       # This is the Domain/URL Traefik is going to use to expose this app
#------------------------------------------------------------------------------------------------------------------------------------------------------
# VOLUME & LOCAL MOUNT POINTS
DATA_VOLUME="UptimeKumaData"                        # Name of the Docker Volume -> Only needed if app needs a Docker Volume!
...
services:
  ${APP_SERVICE}:
    ...
    # Uptime Kuma must be added to every network
    # where it should monitore hosts/services/etc.
    networks:
      system-core:
        ipv4_address: ${SYS_IP}
      apphost:
...
cd /opt/docker/sysapp/uptimekuma

# Run the Container in detached mode
docker compose up -d

# View realtime logs of the container
