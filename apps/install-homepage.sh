...
This Shell Script will install & configure the following App: Homepage
...
⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆
Script Name:   install-homepage.sh
...
APP_FULL_NAME="Homepage"                            # Full name of the App that will be installed (only used for console output)
APP_NAME="homepage"                                 # The folder name of the App (do not use spaces! only use lowercase and - or _ )
APP_SERVICE="Homepage"                              # The Name of the Service (Container Name) for the Compose File
...
APP_PORT="3009"                                     # This is the Port Number which will be exposed for public access
TCP_PORT="3000"                                     # This is the Port Number the Docker Container uses internally
APP_IP="172.24.0.25"                                # The (fixed) IP for the Docker Container (Gateway must already exist!)
APP_DOMAIN="${APP_NAME}.localhost"                  # This is the Domain/URL Traefik is going to use to expose this app
#------------------------------------------------------------------------------------------------------------------------------------------------------
# VOLUME & LOCAL MOUNT POINTS
MOUNTPOINT_APPCONF="${APP_PATH}/config"             # Local Mountpoint
...
# Create local Mountpoint using function from wsl2-lib.sh
CreateLocalMountPoint $MOUNTPOINT_APPCONF 775 1000
...
services:
  ${APP_NAME}:
    ...
    volumes:
      ...
      - ${MOUNTPOINT_APPCONF}:/app/config # Make sure your local config directory exists
    environment:
      # required, may need port. See gethomepage.dev/installation/#homepage_allowed_hosts
      HOMEPAGE_ALLOWED_HOSTS: ${APP_DOMAIN}
