...
This Shell Script will install & configure the following App: Excalidraw
...
⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆
Script Name:   install-excalidraw.sh
...
APP_FULL_NAME="Excalidraw"                          # Full name of the App that will be installed (only used for console output)
APP_NAME="excalidraw"                               # The folder name of the App (do not use spaces! only use lowercase and - or _ )
APP_SERVICE="Excalidraw"                            # The Name of the Service (Container Name) for the Compose File
...
APP_PORT="3008"                                     # This is the Port Number which will be exposed for public access
TCP_PORT="80"                                       # This is the Port Number the Docker Container uses internally
APP_IP="172.24.0.6"                                 # The (fixed) IP for the Docker Container (Gateway must already exist!)
APP_DOMAIN="excalidraw.localhost"                   # This is the Domain/URL Traefik is going to use to expose this app
#------------------------------------------------------------------------------------------------------------------------------------------------------
# VOLUME & LOCAL MOUNT POINTS
DATA_VOLUME="ExcalidrawData"                        # Name of the Docker Volume -> Only needed if app needs a Docker Volume!
MOUNTPOINT1="${APP_PATH}/data"                      # Local Mountpoint for: App-Data
...
while true; do
  ...
  case "$key" in
    ...
    i|I)
      ...
      output_null
      cd $APP_PATH
      docker compose -f $APP_COMPOSE up -d --build --force-recreate --remove-orphans
      output_null
      break
      ;;
    *)
...
cd /opt/docker/appdir/excalidraw
...
# Short Test:
echo "" && curl -s -o /dev/null -w "%{http_code}" http://localhost:EXPOSEDPORT && echo ""
# → should return 200
INFO
