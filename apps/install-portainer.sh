...
This Shell Script will install & configure the following App: PortainerCE
More Informations about this App can be found here: https://docs.portainer.io/
...
⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆
Script Name:   install-portainer.sh
...
APP_FULL_NAME="Portainer CE"                        # Full name of the App that will be installed (only used for console output)
APP_NAME="portainer"                                # The folder name of the App (do not use spaces! only use lowercase and - or _ )
APP_SERVICE="PortainerCE"                           # The Name of the Service (Container Name) for the Compose File
...
APP_PORT="9443"                                     # This is the Port Number which will be exposed for public access
TCP_PORT="9443"                                     # This is the Port Number the Docker Container uses internally
SYS_IP="172.22.0.2"                                 # The (fixed) IP for the Docker Container (Gateway must already exist!)
#------------------------------------------------------------------------------------------------------------------------------------------------------
# VOLUME & LOCAL MOUNT POINTS
DATA_VOLUME="PortainerCEdata"                       # Name of the Docker Volume -> Only needed if app needs a Docker Volume!
...
output_null
output_text "https://localhost:${APP_PORT}"
output_text "or"
output_text "https://${HOST_IP}:${APP_PORT}"
output_null
...
cd /opt/docker/sysapp/portainer
