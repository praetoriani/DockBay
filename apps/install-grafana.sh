...
This Shell Script will install & configure Grafana (Open Source Edition) under WSL2/Debian
...
⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆
Script Name:   install-grafana.sh
...
APP_FULL_NAME="Grafana (Open Source Edition)"       # Full name of the App that will be installed (only used for console output)
APP_NAME="grafana"                                  # The folder name of the App (do not use spaces! only use lowercase and - or _ )
APP_SERVICE="Grafana"                               # The Name of the Service (Container Name) for the Compose File
...
APP_PORT="3003"                                     # This is the Port Number which will be exposed for public access
TCP_PORT="3000"                                     # This is the Port Number the Docker Container uses internally
APP_IP="172.22.0.7"                                 # The (fixed) IP for the Docker Container (Gateway must already exist!)
#------------------------------------------------------------------------------------------------------------------------------------------------------
# VOLUME & LOCAL MOUNT POINTS
DATA_VOLUME="GrafanaStorage"                        # Name of the Docker Volume -> Only needed if app needs a Docker Volume!
