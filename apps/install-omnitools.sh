...
This Shell Script will install & configure the following App: Omni-Tools
...
⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆
Script Name:   install-omnitools.sh
...
APP_FULL_NAME="Omni-Tools"                            # The full name of the App
APP_NAME="omnitools"                                  # The foldername for the App (don't use spaces here)
APP_SERVICE="Omni-Tools"                              # The Name of the Service (Container Name)
APP_PORT="8084"                                       # The Port on which the App should be accessible (Host Port)
TCP_PORT="80"                                         # The Port inside the Docker Container (TCP Port)
APP_IP="172.24.0.10"                                  # The (fixed) IP for the Docker Container (Gateway must already exist!)
APP_DOMAIN="omnitools.localhost"                      # This is the Domain/URL Traefik is going to use to expose this app
...
DATA_VOLUME="OmniToolsData"                           # Name of the Docker Volume -> Only needed if app needs a Docker Volume!
