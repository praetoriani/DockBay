...
APP_FULL_NAME="TaskTrove"                           # Full name of the App that will be installed (only used for console output)
APP_NAME="tasktrove"                                # The folder name of the App (do not use spaces! only use lowercase and - or _ )
APP_SERVICE="TaskTrove"                             # The Name of the Service (Container Name) for the Compose File
...
APP_PORT="3005"                                     # This is the Port Number which will be exposed for public access
TCP_PORT="3000"                                     # This is the Port Number the Docker Container uses internally
APP_IP="172.24.0.15"                                # The (fixed) IP for the Docker Container (Gateway must already exist!)
APP_DOMAIN="tasktrove.localhost"                    # This is the Domain/URL Traefik is going to use to expose this app
#------------------------------------------------------------------------------------------------------------------------------------------------------
# VOLUME & LOCAL MOUNT POINTS
DATA_VOLUME="TaskTroveData"                         # Name of the Docker Volume -> Only needed if app needs a Docker Volume!
...
services:
  ${APP_SERVICE}:
    ...
    environment:
      - AUTH_SECRET=69cdc6ba49b915ef3897ac1d9e41a055832be0508177d943e314b2d843d4d289a55280eb2a1ba300cb3e274bb387b56075770f5543683c8fe03af203db2305c8
